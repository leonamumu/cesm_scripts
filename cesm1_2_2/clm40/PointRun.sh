...
if [ ! -f "domain.ocn_noocean_clm40.nc" ]; then
	cp $CCSMROOT/tools/mapping/gen_domain_files/1x1pt_CN-QYZ_clm40/domain.ocn.domain.ocn_noocean.nc.${CDATE}.nc \
...
cd $CCSMROOT/scripts
export CASE=${GRIDNAME}_${CDATE}_clm40
rm -rf ../clm40/SinglePointExp/$CASE
rm -rf $RUNDIR/$CASE
rm -rf $DOUTDIR/$CASE
./create_newcase -case ../clm40/SinglePointExp/$CASE -res CLM_USRDAT -compset ICN -mach lxfpc
cd ../clm40/SinglePointExp/$CASE
