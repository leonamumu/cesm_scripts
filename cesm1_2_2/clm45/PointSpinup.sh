...
if [ ! -f "domain.lnd.${GRIDNAME}_noocean_clm45.nc" ]; then
	...
	$MYDATA/share/domains/domain.clm/domain.lnd.${GRIDNAME}_noocean_clm45.nc
fi
...
cd $CCSMROOT/scripts
export CASE=${GRIDNAME}_spinup_clm45
rm -rf ../clm45/spinupExp/$CASE
rm -rf $RUNDIR/$CASE
rm -rf $DOUTDIR/$CASE
./create_newcase -case ../clm45/spinupExp/$CASE -res CLM_USRDAT -compset ICRUCLM45BGC -mach lxfpc
cd ../clm45/spinupExp/$CASE
